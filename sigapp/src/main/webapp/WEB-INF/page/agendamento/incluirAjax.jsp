...
<script type="text/javascript" src="public/javascripts/jquery-1.9.1.js" />
<script type="text/javascript" src="public/javascripts/jquery-ui.js" />
...
function funcData(){
	...
	if(document.getElementById('frm_hora_ag01').value==""){	
		alert('A hora n&atilde;o foi escolhida');
		return;
	}
	if(dt=="--"){
...
<form name="frm_inclui_agendamento" method="post" action="${linkTo[AgendamentoController].insert}" enctype="multipart/form-data">
<br>
